    ...
    render() {
        return (
            <div className="container">
                <p></p>
                <p class="fs-1 text-center font-monospace">Linderie</p>
                <p class="fs-4 text-center">" By Cleaning What's On The Outside, You Are Cleaning What's In The Inside "</p>
                <p></p>
                <br></br>
                <p></p>
                <br></br>
                ...
                <div class="text-center">
                    <img src="Frontend\src\pages\laundrybasket.jpg" class="rounded" alt="..."></img>
                </div>
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="card text-center bg-dark m-1">
                            <div className="card-body">
                                ...
                                <h2 className="text-warning">{this.state.jumlahMember}</h2>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="card text-center bg-dark m-1">
                            <div className="card-body">
                                ...
                                <h2 className="text-warning">{this.state.jumlahPaket}</h2>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="card text-center bg-dark m-1">
                            <div className="card-body">
                                ...
                                <h2 className="text-warning">{this.state.jumlahTransaksi}</h2>
                            </div>
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="col-lg-14">
                        <div className="card text-center bg-warning m-1">
                            <div className="card-body">
                                <h4 className="card-title text-dark">Penghasilan</h4>
